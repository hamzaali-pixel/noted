...
class MyNotesLibraryScreen extends StatefulWidget {
  @override
  _MyNotesLibraryScreenState createState() => _MyNotesLibraryScreenState();
}

class _MyNotesLibraryScreenState extends State<MyNotesLibraryScreen> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          // Folders row
          Container(
            height: 110, // Increased height to accommodate icons and text
...
//     super.initState();
//     _notesFuture = DatabaseHelper.getAllNotes();
//     // Initialize with some default folder assignments if needed
//     _initializeNoteFolders();
//   }
  
//   // Initialize folders for existing notes (optional)
//   void _initializeNoteFolders() async {
//     final notes = await DatabaseHelper.getAllNotes();
//     // You could add logic here to assign initial folders
//     // For example, randomly distribute notes to folders for demo purposes
//     for (var note in notes) {
//       if (note.id != null && !_noteFolders.containsKey(note.id)) {
//         // Optional: assign some initial folders
//         // This is just for demonstration - in a real app you'd save this to a database
//       }
//     }
//   }
